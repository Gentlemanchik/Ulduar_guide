...
||||
|:---:|:---:|:---:|
|![motik](/img/Чоппер.png)|Очень быстрая машина, в которой может находится <span style = "color:red"> Водитель </span> и один <span style = "color:green">"Заяц"</span>. Почему "заяц"? Потому что он ничего не делает, у него не будет никаких скилов, в отличии от водителя.| ![mestachop](/img/Чоппер_места.png)|
